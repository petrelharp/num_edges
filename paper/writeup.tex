...
\begin{abstract}
    ...
    To do this, we introduce new metrics of agreement and disagreement between inferred ARGs
    that, unlike previous methods, consider the ARG as describing relationships between haplotypes
...
First proposed by~\cite{kuhner2015assessing}, a common approach 
...
as a measure of disagreement between ARGs.
