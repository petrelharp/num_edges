...
The ancestor and descendant are represented, respectively, by the parent node $p_e$ and child node $c_e$ of the edge. \revpoint{2}{1}
...
an different set of quantities.) \llabel{asymmetric}
