...
%     - guess at typical reduction? (reduces edges by 1/3?)
    ...
    and we will extend the path's edges to the neighboring tree
     ...
     and denoted $F_O$ and $F_O$. \comment{Need better notation. Currently cant think of anything better.}
