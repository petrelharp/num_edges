...
\comment{TODO: describe sims for inference?}
...
\begin{figure}[bht]
	...
	\caption{
        ...
        in an ARG simulated \comment{TODO HOW}.
        \textbf{(A)}
...
the ``simplified'' line (``SS'') on the right of Figure~\ref{fig:dissimilarity} shows
...
(the ``simplified--extended'' line; ``SSE'').
...
\begin{figure}
    ...
    \caption{
        ...
        \comment{TODO: instead of `SS` have `S` ; and instead of `SSE` have `SE`.}
    }
...
\begin{figure}
    ...
    \caption{I think this is being removed?}
\end{figure}
