...
\begin{algorithm2e}[!ht]
    ...
    \caption{
        ...
        (The variables $m$, $M$, and $M'$ are to ensure this ordering
        by number of new edges.)
    }
	\label{alg:extend}
...
These ARGs were simulated with an effective population size of 1,000
...
\comment{Scripts used to produce the results in this paper are available at
\url{https://github.com/XXX/TODO}.}
