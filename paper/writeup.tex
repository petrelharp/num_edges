...
% HF-24NOV : It should be both, as the IE line in Figure 6D shows that inferred trees match the TPR of the ground truth by at least 60% for inferred trees.
...
% HF-24NOV: Peter would we cite Rudin?
