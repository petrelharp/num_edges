...
Counting edges for every iteration suggest that only at most five iterations are needed before the algorithm terminates. Indeed, for even larger sequences \tabref{tab:edge-counts} shows that 99\% of all changes to an ARG occur after the first iteration with the algorithm completing after four iterations. 
...
\begin{figure}
    ...
    \caption{
        ...
        The original tree sequence was simulated with an expanding population;
        see text for details. \comment{TODO}
...
\begin{figure}
    ...
    \caption{
        \label{fig:speed_and_edges_absolute}
    }
\end{figure}
...
\begin{figure}
    ...
    \caption{
        \label{fig:speed_and_edges_timing}
    }
\end{figure}
...
\begin{figure}
    ...
    \caption{
        \label{fig:speed_and_edges_absolute_constant}
    }
\end{figure}
...
\begin{figure}
    ...
    \caption{
        \label{fig:speed_and_edges_timing_constant}
    }
\end{figure}
